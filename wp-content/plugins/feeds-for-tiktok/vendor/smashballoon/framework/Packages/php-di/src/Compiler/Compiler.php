...
namespace TikTokFeeds\Vendor\DI\Compiler;

use function chmod;
use TikTokFeeds\Vendor\DI\Definition\ArrayDefinition;
use TikTokFeeds\Vendor\DI\Definition\DecoratorDefinition;
...
use TikTokFeeds\Vendor\DI\Definition\Source\DefinitionSource;
use TikTokFeeds\Vendor\DI\Definition\StringDefinition;
use TikTokFeeds\Vendor\DI\Definition\ValueDefinition;
use TikTokFeeds\Vendor\DI\DependencyException;
use TikTokFeeds\Vendor\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use TikTokFeeds\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
